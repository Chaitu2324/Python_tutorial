...
def home(request):
    ...
    sign_in_url = get_signin_url(redirect_uri="http://localhost:8000/tutorial/gettoken/")
...
def gettoken(request):
    ...
    redirect_uri = request.build_absolute_uri(reverse('tutorial:gettoken'))
    token = get_token_from_code(auth_code, redirect_uri="http://localhost:8000/tutorial/gettoken/")
